...
const CardActions: React.FC<FarmCardActionsProps> = ({ farm, account, addLiquidityUrl, lpLabel }) => {
  ...
  const renderApprovalOrStakeButton = () => {
    return <StakeAction {...farm} lpLabel={lpLabel} addLiquidityUrl={addLiquidityUrl} />
    // return isApproved ? (
    //   <StakeAction {...farm} lpLabel={lpLabel} addLiquidityUrl={addLiquidityUrl} />
    // ) : (
